# Front-end проект `«StaffPro»`

Разработка административного интерфейса приложения, которое предназначено для HR и содержит базу данных сотрудников. Автор [Александр Бабак](https://portfolio-bbkshow.vercel.app/). Сайт проекта доступен по ссылке [staff-pro.vercel.app](https://staffpro.herokuapp.com/)
