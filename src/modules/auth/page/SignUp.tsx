...
export const SignUp: FC = () => {
  ...
  return (
    <Flex>
      ...
      >
        ...
        <WrapperItem>
          ...
          <Form.Item
            name="patronymic"
            rules={[
              { required: true, message: "Please input your patronymic" },
            ]}
          >
          ...
          rules={[
            {
              validator: (_, value) =>
                value
                  ...
                  : Promise.reject(
                      new Error(
                        "To register, you must accept the terms of the agreement"
                      )
                    ),
            },
          ]}
        >
          <Checkbox>
            Я согласен с пользовательским соглашением и политикой обработки
      ...
      <div>
        Уже есть аккаунт в StaffPro?&nbsp;<Link to="/">Войдите</Link>
      </div>
    </Flex>
  );
};
