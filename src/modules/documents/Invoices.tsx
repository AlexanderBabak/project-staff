    ...
    <>
      ...
      >
        ...
        <TabPaneStyle tab="Due" key="2">
          <TableInvoices
            invoices={invoices.filter((el) => el.type === "due")}
          />
          <CardsInvoices
            invoices={invoices.filter((el) => el.type === "due")}
          />
        ...
        <TabPaneStyle tab="Paid" key="3">
          <TableInvoices
            invoices={invoices.filter((el) => el.type === "paid")}
          />
          <CardsInvoices
            invoices={invoices.filter((el) => el.type === "paid")}
          />
        ...
        <TabPaneStyle tab="Unpaid" key="4">
          <TableInvoices
            invoices={invoices.filter((el) => el.type === "unpaid")}
          />
          <CardsInvoices
            invoices={invoices.filter((el) => el.type === "unpaid")}
          />
        ...
        <TabPaneStyle tab="Archived" key="5">
          <TableInvoices
            invoices={invoices.filter((el) => el.type === "archived")}
          />
          <CardsInvoices
            invoices={invoices.filter((el) => el.type === "archived")}
          />
